...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Story>>,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * getSupportActionBar(); after assigning a mActionBar for ActionBar object
        ...
        // the settings button
        ImageButton settingsButton = customView.findViewById(R.id.action_settings);
        ...
        // the about button
        ImageButton aboutButton = customView.findViewById(R.id.action_about);
